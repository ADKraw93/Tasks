...
class TrelloClientTest {
    ...
    public void shouldCreateCard() throws URISyntaxException {
        ...
        when(trelloConfig.getTrelloAppKey()).thenReturn("test");
        when(trelloConfig.getTrelloToken()).thenReturn("test");
        //when(trelloConfig.getTrelloUsername()).thenReturn("test"); // jeśli tego nie wykomentuję to wywala exception
        ...
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto(
                ...
                "Test task",
                "http://test.com",
                new Badges() //to dodałem od siebie bo tak jakby zapomnieli o tym dodanym elemencie w kursie
        );
    ...
    @Test
    public void shouldReturnEmptyTest() throws URISyntaxException {
        //Given
        when(trelloConfig.getTrelloApiEndpoint()).thenReturn("http://test.com");
        when(trelloConfig.getTrelloAppKey()).thenReturn("test");
        when(trelloConfig.getTrelloToken()).thenReturn("test");
